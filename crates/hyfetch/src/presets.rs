...
impl Preset {
    pub fn color_profile(&self) -> ColorProfile {
        (match self {
            Self::MAP => ColorProfile::from_hex_colors(vec![
                "#5C9FD1", "#9DD2DE", "#F4F492", "#FFFFFF", "#F4F492", "#FFB7C4", "#CB5D7D",
            ])
            ...
            Self::Newgon => ColorProfile::from_hex_colors(vec![
                "#FFA3B0", "#FFC4CC", "#FFE3E7", "#FFFFFF", "#C3F1FF", "#84E3FF", "#00B7F0",
            ])
            .and_then(|c| c.with_weights(vec![2, 2, 2, 1, 2, 2, 2])),
